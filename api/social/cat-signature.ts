...
const CATS: Record<string, Cat> = {
  kun_kun_mao: { id: 'kun_kun_mao', name: '困困猫', tagline: '身体在发出信号，该停下来了', explanation: '你不是懒，是真的耗尽了，身体比你先知道你需要休息。', suggestion: '今天不用完成任何事，休息本身就是今天最重要的任务。', avoid: ['别逼自己撑着把事情做完','别为休息感到愧疚','别喝咖啡硬撑'], recovery_tags: ['睡觉', '躺着', '不设闹钟', '被照顾'], neighbor_cats: ['纸箱猫', '晒太阳猫'], energy: 'low', trigger_type: 'physical' },
  duo_guizi_mao: { id: 'duo_guizi_mao', name: '躲柜子猫', tagline: '不是不想面对，只是今天的能量不够支撑你继续装没事', explanation: '你不是逃避，只是今天需要一个没有人的角落，先把自己收回来。', suggestion: '找一个安静角落待10分钟，让自己先从被看见里退出来。', avoid: ['今天先别硬撑着社交','别解释自己为什么不想说话','别觉得躲起来是软弱'], recovery_tags: ['一个人待着', '安静', '不用解释', '先缩回来'], neighbor_cats: ['纸箱猫', '装死猫'], energy: 'low', trigger_type: 'general' },
  zha_mao_mao: { id: 'zha_mao_mao', name: '炸毛猫', tagline: '不是你脾气不好，是今天的阈值特别低', explanation: '你现在的烦躁是真实的信号，不需要压下去，需要一个出口。', suggestion: '先离开让你烦躁的环境，哪怕只是走出去五分钟。', avoid: ['别在这个状态做重要决定','别跟容易刺激你的人待在一起','别逼自己冷静'], recovery_tags: ['运动', '发泄', '离开现场', '一个人待够了再回来'], neighbor_cats: ['炸锅猫', '暴冲猫'], energy: 'high', trigger_type: 'general' },
  tian_mao_mao: { id: 'tian_mao_mao', name: '舔毛猫', tagline: '焦虑的时候，想把自己整理得干净一点', explanation: '你在用自我整理来应对不安，这是一种本能，没有什么不对。', suggestion: '做一件让自己感觉有秩序的小事，整理桌面、洗个澡、列一个清单。', avoid: ['别让焦虑变成反复检查','别要求自己马上平静下来','别把整理变成新的压力'], recovery_tags: ['整理', '洗澡', '列清单', '找回秩序感'], neighbor_cats: ['绷紧猫', '独自修炼猫'], energy: 'medium', trigger_type: 'anxiety' },
  wei_qu_mao: { id: 'wei_qu_mao', name: '委屈猫', tagline: '你没有做错，只是没有被好好对待', explanation: '委屈说不出口的原因，往往是因为你还在替对方找理由。', suggestion: '今天允许自己委屈，不用马上原谅，不用假装没事。', avoid: ['别说服自己算了没关系','别一个人把委屈咽下去','别急着和解'], recovery_tags: ['说出来', '被听见', '哭一下也行', '不用马上原谅'], neighbor_cats: ['被遗忘猫', '讨好猫'], energy: 'low', trigger_type: 'relationship' },
  bao_chong_mao: { id: 'bao_chong_mao', name: '暴冲猫', tagline: '停不下来，脑子和身体都在超速运转', explanation: '你现在的状态是高转速，不是出了问题，是能量找不到出口。', suggestion: '把这股劲用在一件具体的事上，比什么都不做强。', avoid: ['别在这个状态做需要耐心的事','别跟慢节奏的人产生摩擦','别强迫自己慢下来'], recovery_tags: ['运动', '做事', '消耗掉', '找到出口'], neighbor_cats: ['撒欢猫', '炸毛猫'], energy: 'high', trigger_type: 'general' },
  gaoleng_guancha_mao: { id: 'gaoleng_guancha_mao', name: '高冷观察猫', tagline: '不是冷漠，只是今天不想投入', explanation: '抽离有时候是一种保护，你在用距离给自己缓冲。', suggestion: '今天做旁观者就好，不用强迫自己参与任何事。', avoid: ['别被拉进不想参与的事','别解释自己为什么冷淡','别觉得抽离是问题'], recovery_tags: ['保持距离', '观察', '不表态', '等状态回来'], neighbor_cats: ['窗台猫', '装死猫'], energy: 'medium', trigger_type: 'general' },
  shai_taiyang_mao: { id: 'shai_taiyang_mao', name: '晒太阳猫', tagline: '不是所有事都解决了，只是今天状态还不错', explanation: '稳定本身就是一种好状态，不需要什么特别的理由。', suggestion: '今天的状态值得被好好用，做一件一直想做的事。', avoid: ['别浪费这个好状态在内耗上','别因为好状态就过度消耗','别让别人的负能量把你拉下来'], recovery_tags: ['享受', '做喜欢的事', '充电', '好好吃饭'], neighbor_cats: ['撒欢猫', '困困猫'], energy: 'medium', trigger_type: 'positive' },
  sa_huan_mao: { id: 'sa_huan_mao', name: '撒欢猫', tagline: '今天就是你的好日子，不需要理由', explanation: '能量满格的时候不用分析原因，直接用就行。', suggestion: '把今天的能量用在一件你一直想做但没做的事上。', avoid: ['今天别浪费在无聊的事上','别让别人的低能量把你拉下来','别对这种好状态过度分析'], recovery_tags: ['出门', '找人一起', '做想做的事', '记住今天的感觉'], neighbor_cats: ['暴冲猫', '黏人猫'], energy: 'high', trigger_type: 'positive' },
  nian_ren_mao: { id: 'nian_ren_mao', name: '黏人猫', tagline: '今天特别需要有人在旁边，不一定要说话，就是要有人', explanation: '需要陪伴不是依赖，是你今天的能量需要一个接收者。', suggestion: '主动约一个你想见的人，今天的你值得被陪伴。', avoid: ['别一个人把能量憋着','别等别人主动来找你','别觉得需要人陪是麻烦别人'], recovery_tags: ['主动联系', '找人出门', '说说话', '被陪着'], neighbor_cats: ['撒欢猫', '被遗忘猫'], energy: 'high', trigger_type: 'relationship' },
  beng_jin_mao: { id: 'beng_jin_mao', name: '绷紧猫', tagline: '每一步都踩在钢丝上，不敢停，停了就会掉', explanation: '你不是脆弱，你是一直在用力，从来没有真正松过。', suggestion: '今天不用解决任何问题，只需要让肩膀往下沉三厘米。', avoid: ['今天别逼自己想开点','别跟任何人解释你有多累','别假装一切都还好'], recovery_tags: ['热水', '不说话', '躺着发呆', '有人陪着但不用聊'], neighbor_cats: ['玻璃猫', '舔毛猫'], energy: 'medium', trigger_type: 'anxiety' },
  boli_mao: { id: 'boli_mao', name: '玻璃猫', tagline: '表面没有裂缝，但你知道自己随时可能碎', explanation: '你焦虑的不是现在，是那个你看不见、控制不了的明天。', suggestion: '把万一怎么办这个问题暂停一次，只看今天还剩几个小时。', avoid: ['今天别刷那些让你更慌的信息','别跟自己说别想了','别一个人扛着不说出来'], recovery_tags: ['说出来', '被抱一下', '做一件能完成的小事', '今天只要活着就够了'], neighbor_cats: ['绷紧猫', '等门猫'], energy: 'low', trigger_type: 'anxiety' },
  jia_shui_mao: { id: 'jia_shui_mao', name: '假睡猫', tagline: '眼睛闭着，但耳朵一直竖着', explanation: '你不是真的不在乎，你只是先假装不在乎，万一真的得不到，至少不那么难看。', suggestion: '今天不用决定到底躺不躺，允许自己同时想要又害怕。', avoid: ['今天别看别人的进度','别逼自己想清楚以后要怎样','别对自己说我这样不对'], recovery_tags: ['承认自己还是在乎', '不评判自己', '做一件只为自己的小事', '不用今天想通'], neighbor_cats: ['玻璃猫', '窗台猫'], energy: 'low', trigger_type: 'anxiety' },
  zhouri_wanshang_mao: { id: 'zhouri_wanshang_mao', name: '周日晚上猫', tagline: '还没到明天，但明天已经压过来了', explanation: '你难受的不是现在，是那个还没发生但你已经能感觉到重量的明天。', suggestion: '今晚不用提前承受明天，今晚只是今晚。', avoid: ['别提前演练明天会有多难','别看任何跟工作相关的内容','别假装没事早点睡'], recovery_tags: ['拖延一会儿', '吃点好的', '看废片', '允许自己摆烂到12点'], neighbor_cats: ['绷紧猫', '晒太阳猫'], energy: 'low', trigger_type: 'situation' },
...
const CAT_IMAGES: Record<string, string> = {
  ...
  bao_chong_mao: '/cats/暴冲猫.png',
  gaoleng_guancha_mao: '/cats/高冷观察猫.png',
  shai_taiyang_mao: '/cats/晒太阳猫.png',
  sa_huan_mao: '/cats/撒花猫.png',
  nian_ren_mao: '/cats/黏人猫.png',
  beng_jin_mao: '/cats/绷紧猫.png',
  boli_mao: '/cats/玻璃猫.png',
  jia_shui_mao: '/cats/假睡猫.png',
  zhouri_wanshang_mao: '/cats/周末晚上猫.png',
  zhongwu_mao: '/cats/中午猫.png',
  shimian_mao: '/cats/失眠猫.png',
  huanji_mao: '/cats/换季猫.png',
  jiaqijieshu_mao: '/cats/假期结束猫.png',
  kaoshi_mao: '/cats/考前猫.png',
  milu_mao: '/cats/迷路猫.png',
  shengri_mao: '/cats/生日猫.png',
  zhuangsi_mao: '/cats/装死猫.png',
  dengmen_mao: '/cats/等门猫.png',
  zhaguo_mao: '/cats/炸锅猫.png',
  beiyiwang_mao: '/cats/被遗忘猫.png',
  jidu_mao: '/cats/嫉妒猫.png',
  taohao_mao: '/cats/讨好猫.png',
  bianjie_mao: '/cats/边界猫.png',
  lengzhan_mao: '/cats/冷战猫.png',
  tuomao_mao: '/cats/脱毛猫.png',
  gangxizaowan_mao: '/cats/刚洗完澡猫.png',
  chuangtai_mao: '/cats/窗台猫.png',
  duzilianxi_mao: '/cats/独自修炼猫.png',
  laodifang_mao: '/cats/老地方猫.png',
  diyici_mao: '/cats/第一次猫.png',
  zhixiang_mao: '/cats/纸箱猫.png',
  fadai_mao: '/cats/发呆猫.png',
};
